...
%from the view points of heat dissipation and interference with the signal.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c|YYYY}
    ...
    h [mm] & $\zeta$  & $\omega_{0}$ [rad/s] & $R$ [N$\cdot$s/m] & $k_{z}$ [N/m] \\ \hline
...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.45\hsize}
    \subfigure[]{
      \includegraphics[width=75mm]{vibration_up_2.eps}
    }
  \end{minipage}
  \begin{minipage}{0.45\hsize}
    \centering
    \subfigure[]{
      \includegraphics[width=75mm]{vibration_fit_2.eps}
    }
  \end{minipage}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.45\hsize}
    \subfigure[]{
      \includegraphics[width=75mm]{vibration_fft_B.eps}
    }
  \end{minipage}
  \begin{minipage}{0.45\hsize}
    \centering
    \subfigure[]{
      \includegraphics[width=75mm]{SpringConstant.eps}
    }
  \end{minipage}
