...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.45\hsize}
    \includegraphics[width=50mm]{D400mm.eps}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c|cccc|cccc|}
     & \multicolumn{4}{|c|}{Ha;; sensor} & \multicolumn{4}{|c|}{Laser} \\
    h [mm]& $\zeta$ & $\omega_{0}$ & $R$ &$k_{z}$ & $\zeta$ & $\omega_{0}$ & $R$ &$k_{z}$ \\ \hline
    3  & 0.024 & 299.335 & 43.5 & 2.7$\times10^{5}$ & X & X & X & X \\
    6  & 0.023 & 195.731 & 27.1 & 1.2$\times10^{5}$ & X & X & X & X \\
    9  & 0.024 & 136.369 & 20.2 & 5.6$\times10^{4}$ & X & X & X & X \\
    12 & 0.024 & 107.970 & 15.722 & 3.5$\times10^{4}$ & X & X & X & X \\
  \end{tabular}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=60mm]{vibration_fit.eps}
  \caption{The laser gauge output (top) and the Hall sensor output (bottom) as a function of time with the leviation height of 9~mm}
  \label{fig:vibration_up}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=60mm]{vibration_fft_B.eps}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=60mm]{SpringConstant.eps}
  \caption{}
...
From the measurement, the spring constant is in the order of XX~Nm and the damping coefficient is XX for each levitation height.
