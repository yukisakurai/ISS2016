\documentclass[a4paper,11pt]{jpconf}
\usepackage{graphicx}
\usepackage{color}
\usepackage{array}
...
%  heat dissipation is expected to be smaller than that from a conventional mechanical bearing, 
...
We conduct vibration measurements using a Styrofoam bucket with liquid nitrogen as shown in Figure \ref{fig:d400} (a). Hull et al. has reported the vibrational properties of the SMB system at both the liquid nitrogen and the liquid helium temperature. The results show no significant difference due to the temperature differences. Therefore, we start characterizing the vibrational properties at a liquid nitrogen temperature although the SMB system is operated inside the 4~K cryostat in an actual CMB observation.
...
which is mounted on an aluminum frame at a distance of 260~mm from the rotor magnet as shown in the figure \ref{fig:d400} (a).
...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.6\hsize}
    \subfigure[]{
      \includegraphics*[width=95mm,height=60mm]{D400mm.eps}
    }
  \end{minipage}
  \begin{minipage}{0.3\hsize}
    \centering
    \subfigure[]{
      \includegraphics*[width=50mm,height=60mm]{SpringSystem.eps}
    }
  \end{minipage}
...
An axial vibration of the rotor can be described by a damping motion of a mass-spring-damper model \cite{mds} shown in the figure \ref{fig:d400} (b).
...
The figure \ref{fig:vibration} (a) shows the laser displacement gauge output and the Hall sensor output as a function of time at the levitation height of 9~mm.
...
The fitting result of the Hall sensor output with the levitation height of 12~mm is shown in the figure \ref{fig:vibration} (b).
