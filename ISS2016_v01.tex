...
In this paper, we discuss the design tradeoff for use of this SMB technology for a future CMB polarization experiment, in particular for use in space. 
We present our prototype SMB system, rotor diameter of 384~mm, and the measurements of the spring constant and the damping to characterize the mechanical properties.
In order to characterize the mechanical properties, we use a laser interferometer, which we can use in a lab but cannot use during observations. 
